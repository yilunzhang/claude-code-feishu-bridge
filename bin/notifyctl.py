#!/usr/bin/env python3
"""notifyctl:agent 主动给「本 session 绑定的飞书群」发通知,系统自动前缀 @owner
(`<at user_id=owner></at>`,穿透免打扰),凸显"需 owner 决策/授权的 blocker"。

**定位(关键假设,别 overdesign)**:个人轻量工具、单用户、群内可信;agent = 可信主体
...
from lib import constants, db, paths, procs, runner as runner_mod, util  # noqa: E402
